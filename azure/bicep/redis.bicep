...
@description('Optional. Deloy Active-Active')
...
resource redisLocation2 'Microsoft.Cache/redisEnterprise@2022-01-01' =  if(activeGeoReplicationEnabled) {
...
resource redisLocation2Db 'Microsoft.Cache/redisEnterprise/databases@2022-01-01' = if(activeGeoReplicationEnabled) {
  name: resourceNames.redisDbName
...
output redisLocation2Id string  = redisLocation2.id
